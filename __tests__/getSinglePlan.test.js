...
describe('GET A SINGLE plan by Id pattern', () => {
    let req, res;
    ...
    it('should successfully return status 200 and a single plan with a valid Id match', async () => {
        ...
        await plansController.getSinglePlan(req, res);
    ...
    it('should return a 404 status and error message when the id doesnt exist', async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({ message: "Training plan not found" });
    });
});